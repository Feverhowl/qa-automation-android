// Тест №006
// Корректное начисление сейвкоинов

package main;

import org.openqa.selenium.By;

public class Test006 extends Main {

    public static final String NAME = "Тест №006 - End to End - Корректное начисление сейвкоинов";

    public static void test006(String deviceName) {
        ...
        // Запоминаем количество сейвкоинов
        String before = rememberSavecoinAmount();
        ...
        // Запоминаем количество сейвкоинов
        String after = rememberSavecoinAmount();

        // Проверяем, что начислилось корректное количество сейвкоинов
        assertSavecoinsAccured(order, client, before, after);
    }
}
