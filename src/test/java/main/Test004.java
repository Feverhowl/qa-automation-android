// Тест №004
// End to End тест - проверка работы процентного промокода.

package main;

import org.openqa.selenium.By;

public class Test004 extends Main {

    public static final String NAME = "Тест №004 - End to End - Проверка работы процентного промокода";

    public static void test004(String deviceName) {
        ...
        fillCommentField("Первый! Первый! Как слышно? Проверка работы процентного промокода.");
